...
from ift_global.credentials.email import MailConfig
from ift_global.email.html_tools import (
    jinja_to_html,
    inject_stylesheet
)
...
class EmailClient:
    ...
    def __init__(self, template_dir : str = None, template_name : str = None, loc_vars=vars(), **kwargs):
        ...
        :Examples:
            ...
            ...                 smtp_server='smtpin.biz.lodh.com',
            ...                 smtp_port=25
            ...                )
            >>> mail_client.send_mail(msg_from='no_reply_sirs@lombardodier.com',
            ...                       msg_to="f.bar@lombardodier.com",
            ...                       mail_subject='SIRS COMMON Auto Testing'
            ...                       )
        """
